...
import {
  JSON_SCHEMA,
  load
} from "./chunk-F3U74UJN.js";
import {
  registerLayoutLoaders
} from "./chunk-QJL7DHEO.js";
import "./chunk-53P3UUFG.js";
import "./chunk-4EOMMTBT.js";
import "./chunk-WIF6GQYV.js";
import "./chunk-T7VA5XL6.js";
import "./chunk-FW7BXNVI.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-REZAT3SI.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./c4Diagram-YG6GDRKO-7AQ4JEY4.js");
  return {
    id,
    diagram: diagram2
  };
...
var loader2 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./flowDiagram-NV44I4VS-OSQVVR4P.js");
  return {
    id: id2,
    diagram: diagram2
  };
...
var loader4 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./erDiagram-Q2GNP2WA-MHJ7U267.js");
  return {
    id: id4,
    diagram: diagram2
  };
...
var loader5 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./gitGraphDiagram-V2S2FVAM-WGQZLN3Z.js");
  return {
    id: id5,
    diagram: diagram2
  };
...
var loader6 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./ganttDiagram-JELNMOA3-PDRPTHWC.js");
  return {
    id: id6,
    diagram: diagram2
  };
...
var loader7 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./infoDiagram-HS3SLOUP-PZEYXW3S.js");
  return {
    id: id7,
    diagram: diagram2
  };
...
var loader8 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./pieDiagram-ADFJNKIX-JSTAHUIW.js");
  return {
    id: id8,
    diagram: diagram2
  };
...
var loader9 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./quadrantDiagram-AYHSOK5B-KIQT7JF7.js");
  return {
    id: id9,
    diagram: diagram2
  };
...
var loader10 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./xychartDiagram-PRI3JC2R-3XZQP3MF.js");
  return {
    id: id10,
    diagram: diagram2
  };
...
var loader11 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./requirementDiagram-UZGBJVZJ-MCBMTYST.js");
  return {
    id: id11,
    diagram: diagram2
  };
...
var loader12 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./sequenceDiagram-WL72ISMW-FCELYLT4.js");
  return {
    id: id12,
    diagram: diagram2
  };
...
var loader13 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./classDiagram-2ON5EDUG-R2T6AZ2D.js");
  return {
    id: id13,
    diagram: diagram2
  };
...
var loader14 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./classDiagram-v2-WZHVMYZB-7KB2TD7D.js");
  return {
    id: id14,
    diagram: diagram2
  };
...
var loader15 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./stateDiagram-FKZM4ZOC-YEBSUIBA.js");
  return {
    id: id15,
    diagram: diagram2
  };
...
var loader16 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./stateDiagram-v2-4FDKWEC3-PEAWRLPK.js");
  return {
    id: id16,
    diagram: diagram2
  };
...
var loader17 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./journeyDiagram-XKPGCS4Q-5HHNW7T5.js");
  return {
    id: id17,
    diagram: diagram2
  };
...
var loader19 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./timeline-definition-IT6M3QCI-CMVXCTL6.js");
  return {
    id: id19,
    diagram: diagram2
  };
...
var loader20 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./mindmap-definition-VGOIOE7T-O7N7QRCV.js");
  return {
    id: id20,
    diagram: diagram2
  };
...
var loader21 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./kanban-definition-3W4ZIXB7-7GJ7PREX.js");
  return {
    id: id21,
    diagram: diagram2
  };
...
var loader22 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./sankeyDiagram-TZEHDZUN-QYBAK5FX.js");
  return {
    id: id22,
    diagram: diagram2
  };
...
var loader23 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-S2PKOQOG-MHDZF5K4.js");
  return {
    id: id23,
    diagram: diagram2
  };
...
var loader24 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-QEK2KX5R-TGVRJFPH.js");
  return {
    id: id24,
    diagram: diagram2
  };
...
var loader25 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./blockDiagram-VD42YOAC-VYXBV4NR.js");
  return {
    id: id25,
    diagram: diagram2
  };
...
var loader26 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./architectureDiagram-VXUJARFQ-RSIJJRKX.js");
  return {
    id: id26,
    diagram: diagram2
  };
...
var loader27 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-PSM6KHXK-WYG67JSR.js");
  return {
    id: id27,
    diagram: diagram2
  };
